...
private:
    ...
    std::string substringUntilNewlineNotTabbed(std::string);
    std::map<std::string,std::string> rawEventToMap(std::string);
    std::map<std::string,std::string> rawUpdatesToMap(std::string);
